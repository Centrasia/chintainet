<?php
/**
  * Template Name: お部屋・賃貸スレッド投稿フォーム
*/
	 get_header();
;?>
        ...
        <div class="breadcrumbs">
         ...
         <div class="content_inner">
           ...
           <h3>投稿を作成する</h3>
        	...
        	<?php wp_nonce_field('post_property'); ?>
			<?php show_property_error(); ?>
            <table class="form-table">
            <tbody>
            <tr>
                <th colspan="1"><label for="title">投稿タイトル <span class="att">※</span></label></th>
            ...
            <tr>
             ...
             <tr>
                <th>お部屋写真1 </th>
                <td><input id="pics" type="file" name="propety_image01" accept="image/*"/>
                 </td>
                <th>お部屋写真2 </th>
